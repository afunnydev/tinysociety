---
title: Tiny House Builders in Florida
description: >-
  Finding the right tiny house builder for your future home can be challenging
  if you haven't done your research. Here is a list of some of the top tiny
...
listing:
  title: Tiny House Builders in Florida
  description: >-
    As mentioned in our previous article, How to Find a Tiny House Builder, not
...
* **Tiny houses on wheels:** no, but shipping containers can be transported a variety of different ways
* **Tiny houses on foundations:** yes
* **Custom builds:** yes
* **Certifications:** N/A
* **Tiny house financing partners:** no 
...
Contact the builder [here](http://norsktinyhouses.com/#contact) for more information.
