...
Aspiring tiny house owners can also [create a storyboard](https://invideo.io/make/storyboard/) to map out their ideal floor plan, room priorities, and lifestyle needs, visually making it easier to communicate their vision to an architect or builder before the design process begins.

You'll want to have a good idea of what you want before enlisting the help of an architect who charges an hourly rate after [tracking time](https://unrubble.com/products/time-tracking) spent on the project.
